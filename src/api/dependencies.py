...
def get_intelligent_plugin_router() -> IntelligentPluginRouter:
    """获取智能插件路由器"""
    return container.get(IntelligentPluginRouter)
...
IntelligentPluginRouterDep = Annotated[IntelligentPluginRouter, Depends(get_intelligent_plugin_router)]
